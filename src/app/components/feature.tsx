...
const TripMatesCard = ({ title, description, imageAlt }: TripMatesCardProps) => {
  return (
    ...
    <div className=" backdrop-blur-[32.4px] rounded-[36px] bg-white/30 border border-white box-border flex flex-col p-8 gap-8 md:flex-col items-center justify-start">
      <Image 
